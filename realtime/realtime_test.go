...
func TestRealTime(t *testing.T) {
	cases := []struct {
		...
		{Name: "org", ApiKey: "1234", Email: "org-test@example.com", HostID: "org-based-host", Status: "running", Version: "1.0.0", RetCode: http.StatusNoContent},
		{Name: "org", ApiKey: "1234", Email: "org-test@example.com", HostID: "org-based-host", Status: "running", Version: "1.0.0", RetCode: http.StatusOK},
		{Name: "user", ApiKey: "", Email: "test@example.com", HostID: "email-based-host", Version: "unknown", RetCode: http.StatusNoContent},
		{Name: "user", ApiKey: "", Email: "test@example.com", HostID: "email-based-host", Version: "unknown", RetCode: http.StatusNoContent},
	}
...
func testPostSpeedTestResult() func(t *testing.T) {
	return func(t *testing.T) {
		...
		err := realtime.PostSpeedTestRealtimeResults(context.Background(), "complete", testURL.String(), 1.0, 1.0)
		is.NoErr(err)
	}
}
